...
function(_get_resource_class_name resource_dir resource_file)
  set(resource_class_name ${resource_file})
  path_remove_extension (resource_class_name ${resource_class_name})
  remove_special        (resource_class_name ${resource_class_name})
...
function(_get_resource_file_content resource_dir resource_file)
  ...
  if(resource_file_content STREQUAL "")
    set(resource_file_content 00)
  endif()
